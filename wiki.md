...
## string.split *`LuaU`* *`Lua5.1`* *`Lua5.4`*
```lua
...
## table.tostring *`LuaU` `Lua5.1` `Lua5.4`*
```lua
...
## table.destroy *`LuaU` `Lua5.1` `Lua5.4`*
```lua
table.destroy(t: {}): {}
```
...
## table.replace *`LuaU` `Lua5.1` `Lua5.4`*
```lua
table.replace(t: {}, vt: {}): {}
```
Replaces each value in `t` which has the same index as in `vt`

## table.deepreplace *`LuaU` `Lua5.1` `Lua5.4`*
```lua
table.deepreplace(t: {}, vt: {}): {}
```
Same as `table.replace` but instead replaces values in table values as well.

## table.find *`LuaU` `Lua5.1` `Lua5.4`*
```lua
table.find(t: {}, value: any): number?
```
[Documentation for table.find](https://create.roblox.com/docs/reference/engine/libraries/table#find) except it has not init argument.

## table.findkey *`LuaU` `Lua5.1` `Lua5.4`*
```lua
...
## table.deeplen *`LuaU` `Lua5.1` `Lua5.4`*
```lua
...
## table.clear *`(Already in LuaU)` `Lua5.1` `Lua5.4`*
```lua
table.clear(t: {}): {}
```
...
## math.ult *`LuaU` `Lua5.1` `(Already in 5.4)`*
```lua
math.ult(m: number, n: number): boolean
```
Returns a boolean, true if and only if integer `m` is below integer `n` when they are compared as unsigned integers.

## math.rounddec *`LuaU` `Lua5.1` `Lua5.4`*
```lua
...
## math.decimal *`LuaU` `Lua5.1` `Lua5.4`*
```lua
...
## math.randomfloat *`LuaU` `Lua5.1` `Lua5.4`*
```lua
