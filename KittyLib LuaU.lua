...
do -- math
	...
	-- other
	function math.rounddec(n: number, decimal: number): number
...
do -- table
	...
	function table.isdeepfrozen(t: {}): boolean
	...
	function table.findkey(t: {}, index: string): number?
	...
	function table.deeplen(t: {}): number
		local len = 0
		for i, v in next, t do
			len = len + 1
			if type(v) == "table" then
